...
#../xcibyl-translator config:"config:colocate_functions=main;run_tests,optimize_partial_memory_operations=1,class_size_limit=99999999" -DMABOO=1  out $CIBYL_BASE/tests/c/program $CIBYL_BASE/include/generated/cibyl-syscalls.db $CIBYL_BASE/tests/include/cibyl-syscalls.db
